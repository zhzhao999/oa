	...
	<div class="panel-body">
		<div class="topwrap">
			<form class="form-inline">
					...
					<input id="changeTree" class="btn btn-primary btn-sm" type="button" value="切换">
					</div>
				</form>
...
$(function(){
	$('#changeTree').on('click',function(){
		window.location.href="${ctx}/dict/showTree"; 
	});
